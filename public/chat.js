...
let iconemoji = document.querySelector('.icon_emoji')
let box_emojis = document.querySelector('.box_emojis')
let box_imput = document.querySelector('.box_imput')
let iconimput = document.querySelector('.icon_imput')
...
iconemoji.addEventListener('click',() =>{
    box_emojis.classList.toggle('open_box_emojis')
})

iconimput.addEventListener('click',() =>{
    box_imput.classList.toggle('open_box_imput')
})

for(const emojis of emoji){
    emojis.addEventListener('click',()=>{
        message.setAttribute("value", document.getElementById('message-area').value += emojis.innerHTML)
    })
}
